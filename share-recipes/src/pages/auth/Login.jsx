      ...
      <div className="bg-custom-main text-custom-butbrown shadow-bg rounded-lg py-12 px-20">
        ...
        "
          >
            ...
            <input
              className={`${
                errors.email ? "border-4 border-red-600" : "border-none"
              }`}
            ...
            <input
              className={`${
                errors.password ? "border-4  border-red-600" : "border-none"
              }`}
              onChange={handleInput}
              type="password"
              name="password"
            ...
            <div className=" flex flex-col mt-4">
              <button
                ...
                className="py-3 bg-custom-main font-bold text-xl shadow-btn duration-200 active:translate-y-[7px] active:translate-x-[7px] active:shadow-none border border-yellow-800 rounded-md "
              >
                Login
              </button>
