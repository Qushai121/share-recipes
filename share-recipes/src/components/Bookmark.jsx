...
const Bookmark = ({ bookmarks, style,wrapper, fill }) => {
//   console.log(bookmarks);
  const bookmark = kFormatter(bookmarks?.bookmark);
  ...
  // className="flex flex-col w-10 justify-center p-1"
  return (
    <>
      {true ? (
    ...
    3.4-24.9-1.8L192 397.5 37.9 507.5c-7.3 5.2-16.9 5.9-24.9 1.8S0 497 0 488V48z"
          ...
          <p className="text-[10px] flex justify-center overflow-x-scroll">{bookmark || "0"}</p>
        </div>
      ) : (
        <div className={wrapper}>
          <div onClick={() => giveBookmark()} className={style}>
